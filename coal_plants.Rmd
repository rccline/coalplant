---
title: "CO2 Emissions by EU Coal Plants"
author: "Robert Cline"
date: "10/23/2021"
...
This is a list of coal plants that meet the criteria of 800MW as calculated by using the $CO_2$ production from the reported in the European Coal Database. 

* *2021-07-21*  Last update to "Plant" object, which is a list of all EU coal plants in the EDC database as of date 2021-07-21. 
* *plant_names.csv* is saved from "plant" dataframe object  
  - write_csv(plant, "E:/coal/data/plant_names.csv")  
  - includes vars: *plant_id* and *fuel_type*
...
df0 <- plant %>%  # 3
  select(plant_id, plant_name,fuel_type,longitude, latitude, "x2005", "x2006", "x2007", "x2008", "x2009", "x2010", "x2011", "x2012", "x2013", "x2014", "x2015", "x2016", "x2017", "x2018", "x2019")
...
Plants with power capacity > 800 MW predicted by maximum annual $CO_2$ emmissions.  
...
Plants being phased out before 2018 and after 2029.
```{r}
phaseout_plants <- df_pvt2 %>% 
  filter(year >2018) %>% 
  filter(year<2030)
...
```{r eval=FALSE}
# library(readr)
# write_csv(df_pvt2, "./data/plant_lat_lon.csv")
# temp <- read.csv("./data/plant_lat_lon.csv")
```
