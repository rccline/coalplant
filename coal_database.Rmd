...
df0 <- plant %>%  # 3
  select(plant_id, plant_name, owner, fuel_type, retirement, longitude, latitude, "x2005", "x2006", "x2007", "x2008", "x2009", "x2010", "x2011", "x2012", "x2013", "x2014", "x2015", "x2016", "x2017", "x2018", "x2019", "x2020")# %>% 
#  mutate(retirment=as.numeric(retirement))

df0$retirement

df0 <- plant %>% 
  select(plant_id, fuel_type, capacity, retirementYr, "x2005", "x2006", "x2007", "x2008", "x2009", "x2010", "x2011", "x2012", "x2013", "x2014", "x2015", "x2016", "x2017", "x2018", "x2019", "x2020")

df_pvt <- df0 %>% 
  pivot_longer(!1:7, names_to = "year",
               values_to = "co2")
``` 
